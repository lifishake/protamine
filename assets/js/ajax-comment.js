jQuery(document).ready(function(jQuery) {
	...
	function() {
		jQuery.ajax({
			...
			data: jQuery(this).serialize() + "&action=ajax_comment"+"&nonce="+jQuery('#submit').attr('wpnonce'),
	...
	function() {
		jQuery.ajax({
			url: ajaxcomment.ajax_url,
			data: jQuery('#commentform').serialize() + "&action=ajax_comment&grasp=1"+"&nonce="+jQuery('#grasp').attr('wpnonce'),
